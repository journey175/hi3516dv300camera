...
static HI_S32 SAMPLE_SVP_NNIE_Ssd_Face_detect_SoftwareInit(SAMPLE_SVP_NNIE_CFG_S* pstCfg,
    SAMPLE_SVP_NNIE_PARAM_S *pstNnieParam, SAMPLE_SVP_NNIE_SSD_SOFTWARE_PARAM_S* pstSoftWareParam)
{
    HI_U32 i = 0;
    HI_S32 s32Ret = HI_SUCCESS;
    ...
    //pstSoftWareParam->as32PriorBoxVar[2] = (HI_S32)(0.2f*SAMPLE_SVP_NNIE_QUANT_BASE);
    //pstSoftWareParam->as32PriorBoxVar[3] = (HI_S32)(0.2f*SAMPLE_SVP_NNIE_QUANT_BASE);
    pstSoftWareParam->as32PriorBoxVar[0] = (HI_DOUBLE)(0.1f);
    pstSoftWareParam->as32PriorBoxVar[1] = (HI_DOUBLE)(0.1f);
    pstSoftWareParam->as32PriorBoxVar[2] = (HI_DOUBLE)(0.2f);
    pstSoftWareParam->as32PriorBoxVar[3] = (HI_DOUBLE)(0.2f);
...
#if 0
    pstSoftWareParam->au32SoftMaxInChn[0] = 17328;
    pstSoftWareParam->au32SoftMaxInChn[1] = 6498;
    pstSoftWareParam->au32SoftMaxInChn[2] = 1800;
    pstSoftWareParam->au32SoftMaxInChn[3] = 450;
    pstSoftWareParam->au32SoftMaxInChn[4] = 108;
    pstSoftWareParam->au32SoftMaxInChn[5] = 12;
#else

    pstSoftWareParam->au32SoftMaxInChn[0] = 11552;
    pstSoftWareParam->au32SoftMaxInChn[1] = 4332;
    pstSoftWareParam->au32SoftMaxInChn[2] = 1200;
    pstSoftWareParam->au32SoftMaxInChn[3] = 300;
    pstSoftWareParam->au32SoftMaxInChn[4] = 72;
    pstSoftWareParam->au32SoftMaxInChn[5] = 8;
    ...
    pstSoftWareParam->u32NmsThresh = (HI_DOUBLE)0.45;
    //pstSoftWareParam->u32ConfThresh = 1;
    pstSoftWareParam->u32ConfThresh = (HI_DOUBLE)0.01;
	...
	pstSoftWareParam->au32DetectInputChn[0] = 14440;
    pstSoftWareParam->au32DetectInputChn[1] = 5415;
    pstSoftWareParam->au32DetectInputChn[2] = 1500;
    pstSoftWareParam->au32DetectInputChn[3] = 375;
    pstSoftWareParam->au32DetectInputChn[4] = 90;
    pstSoftWareParam->au32DetectInputChn[5] = 10;
...
#endif
	//pstSoftWareParam->au32ConvStride[0] = 8;
	//pstSoftWareParam->au32ConvStride[1] = 12;
	//pstSoftWareParam->au32ConvStride[2] = 12;
	//pstSoftWareParam->au32ConvStride[3] = 12;
	//pstSoftWareParam->au32ConvStride[4] = 8;
	//pstSoftWareParam->au32ConvStride[5] = 8;	
...
* function : Ssd init
******************************************************************************/
static HI_S32 SAMPLE_SVP_NNIE_Ssd_Face_detect_ParamInit(SAMPLE_SVP_NNIE_CFG_S* pstCfg,
    SAMPLE_SVP_NNIE_PARAM_S *pstNnieParam, SAMPLE_SVP_NNIE_SSD_SOFTWARE_PARAM_S* pstSoftWareParam)
{
    HI_S32 s32Ret = HI_SUCCESS;
    /*init hardware para*/
    ...
    /*init software para*/
    s32Ret = SAMPLE_SVP_NNIE_Ssd_Face_detect_SoftwareInit(pstCfg,pstNnieParam,
        pstSoftWareParam);
    SAMPLE_SVP_CHECK_EXPR_GOTO(HI_SUCCESS != s32Ret,INIT_FAIL_0,SAMPLE_SVP_ERR_LEVEL_ERROR,
        "Error(%#x),SAMPLE_SVP_NNIE_Ssd_SoftwareInit failed!\n",s32Ret);
...
HI_S32 SAMPLE_SVP_NNIE_SSD_Init(HI_CHAR *pcModelName)
{
    ...
    SAMPLE_SVP_CHECK_EXPR_GOTO(HI_SUCCESS != s32Ret,SSD_FAIL_0,SAMPLE_SVP_ERR_LEVEL_ERROR,
        "Error,SAMPLE_COMM_SVP_NNIE_LoadModel failed!\n");
    printf("SAMPLE_COMM_SVP_NNIE_LoadModel ok!\n");

    SAMPLE_SVP_TRACE_INFO("Ssd parameter initialization!\n");
    s_stSsdNnieParam.pstModel = &s_stSsdModel.stModel;

    s32Ret = SAMPLE_SVP_NNIE_Ssd_Face_detect_ParamInit(&stNnieCfg,&s_stSsdNnieParam,&s_stSsdSoftwareParam);
    SAMPLE_SVP_CHECK_EXPR_GOTO(HI_SUCCESS != s32Ret,SSD_FAIL_0,SAMPLE_SVP_ERR_LEVEL_ERROR,
        "Error,SAMPLE_SVP_NNIE_Ssd_ParamInit failed!\n");
    
     printf("SAMPLE_SVP_NNIE_Ssd_Face_detect_ParamInit ok!\n");
...
)
{
    ...
    SAMPLE_SVP_NNIE_INPUT_DATA_INDEX_S stInputDataIdx = {0};
    SAMPLE_SVP_NNIE_PROCESS_SEG_INDEX_S stProcSegIdx = {0};
    s_stSsdNnieParam.astSegData[stInputDataIdx.u32SegIdx].astSrc[stInputDataIdx.u32NodeIdx].u64PhyAddr = src->au64PhyAddr[0];
    s_stSsdNnieParam.astSegData[stInputDataIdx.u32SegIdx].astSrc[stInputDataIdx.u32NodeIdx].u64VirAddr = src->au64VirAddr[0];
    
    stProcSegIdx.u32SegIdx = 0;
    s32Ret = SAMPLE_SVP_NNIE_Forward(&s_stSsdNnieParam,&stInputDataIdx,&stProcSegIdx,HI_TRUE);
    SAMPLE_SVP_CHECK_EXPR_GOTO(HI_SUCCESS != s32Ret,BASE_RELEASE,SAMPLE_SVP_ERR_LEVEL_ERROR,
        "Error,SAMPLE_SVP_NNIE_Forward failed!\n");
    //printf("SAMPLE_SVP_NNIE_Forward ok!\n");

    s32Ret = SAMPLE_SVP_NNIE_Ssd_GetResult(&s_stSsdNnieParam,&s_stSsdSoftwareParam);
        SAMPLE_SVP_CHECK_EXPR_GOTO(HI_SUCCESS != s32Ret,BASE_RELEASE,SAMPLE_SVP_ERR_LEVEL_ERROR,
            "Error,SAMPLE_SVP_NNIE_Ssd_GetResult failed!\n");
    //printf("SAMPLE_SVP_NNIE_Ssd_GetResult ok!\n");

    s32Ret = SAMPLE_SVP_NNIE_RoiToRect(&(s_stSsdSoftwareParam.stDstScore),
        &(s_stSsdSoftwareParam.stDstRoi), &(s_stSsdSoftwareParam.stClassRoiNum),paf32ScoreThr,HI_TRUE,array,
        check_w,check_h,original_w, original_h);
        SAMPLE_SVP_CHECK_EXPR_RET(HI_SUCCESS != s32Ret,HI_NULL,SAMPLE_SVP_ERR_LEVEL_ERROR,
        "Error(%#x),SAMPLE_SVP_NNIE_RoiToRect failed!\n",s32Ret);
    
    //printf("SAMPLE_SVP_NNIE_RoiToRect ok!\n");
    return 0;
